...
public class SearchBestCustomer extends javax.swing.JFrame {
    ...
    private void loadBestCustomerData() {
        ...
        for (int i = 0; i < burgers.length; i++) {
            if (!list.searchDuplicateCustomers(bestCustomers, burgers[i].getCustomerId())) {
        ...
        for (Burger burger : bestCustomers) {
            Object[] rowData = {burger.getCustomerId(), burger.getCustomerName(), (double) burger.getOrderQty() * Burger.bgrPrice};
            dtm.addRow(rowData);
        }
    }
